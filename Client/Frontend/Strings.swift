...
extension Strings {
    ...
    public static let HighlightTrendingText = NSLocalizedString("ActivityStream.Trending.SectionTitle", value: "Trending Story", comment: "The description of a highlight if it is a trending pocket story")
